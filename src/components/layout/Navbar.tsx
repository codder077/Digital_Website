...
const Navbar = () => {
  ...
  return (
    <nav className={navbarClasses}>
      <div className="container-custom flex items-center justify-between">
        ...
        >
          <span className="text-primary">Elite8</span>
        ...
        <div className="flex items-center md:hidden space-x-4">
          ...
          >
            {isOpen ? (
              <X className="w-6 h-6 text-black dark:text-white bg-white dark" />
            ) : (
              <Menu className="w-6 h-6 text-neutral-800 dark:text-white bg-white " />
            )}
          </button>
        </div>
  ...
  className="fixed top-0 left-0 w-full h-screen  z-40 flex flex-col justify-center items-center p-8 bg-black text-white"
>
        ...
        <Link
          ...
          className={`text-3xl font-medium ${
            location.pathname === item.path
              ...
              : 'text-white/80 dark:text-white hover:text-white'
          }`}
        >
          {item.name}
        </Link>
