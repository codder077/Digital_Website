...
const Contact = () => {
  ...
  useEffect(() => {
    // Update page title
    document.title = 'Contact Us | Elite8_Digital';
  ...
  <div className="container-custom">
    <motion.div
      ...
      className="max-w-3xl"
    >
      <h1 className="mb-6 text-4xl font-semibold tracking-tight leading-tight">
        Let’s Create Something Exceptional Together
      </h1>
      <p className="text-lg text-neutral-300 leading-relaxed">
        Whether you're exploring ideas, scaling a vision, or refining digital experiences — our team at <strong>Elite8 Digital</strong> is ready to collaborate. Reach out and let’s turn your ambitions into reality.
      </p>
    </motion.div>
  </div>
</section>
  ...
  <div className="flex items-start gap-4">
    ...
    <div>
      ...
      <p className="text-neutral-600 dark:text-neutral-400">hello@elite8digital.in</p>
      <p className="text-neutral-600 dark:text-neutral-400">support@elite8digital.in</p>
    </div>
  </div>
  ...
  <div className="flex items-start gap-4">
    ...
    <div>
      ...
      <p className="text-neutral-600 dark:text-neutral-400">Mon–Fri, 10:00 AM – 6:00 PM IST</p>
    </div>
  </div>
  ...
  <div className="flex items-start gap-4">
    ...
    <div>
      ...
      <p className="text-neutral-600 dark:text-neutral-400">Elite8 Digital, 4th Floor, Innov8 Tower</p>
      <p className="text-neutral-600 dark:text-neutral-400">Sector 44, Gurgaon, Haryana 122003</p>
    </div>
  </div>
</div>
