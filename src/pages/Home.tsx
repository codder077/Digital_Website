...
const Home = () => {
  ...
  return (
    <main>
      {/* Hero Section */}
      <section className="min-h-screen pt-40 pb-20 relative overflow-hidden bg-white dark:bg-neutral-900 transition-colors duration-1000">
  <div className="container-custom relative z-10">
    ...
    >
      <motion.h1
        ...
        className="mb-6 text-5xl md:text-6xl font-bold leading-tight tracking-tight text-neutral-900 dark:text-white"
      >
        Elite<span className="text-primary">8</span> Digital
      </motion.h1>
      ...
      <motion.p 
        ...
        className="text-xl md:text-2xl text-neutral-600 dark:text-neutral-300 mb-8 max-w-2xl mx-auto font-light"
      >
        We craft refined digital experiences that blend strategy, design, and technology — helping brands define their presence and elevate their impact.
      </motion.p>
      ...
      <motion.p 
        ...
        className="text-base md:text-lg text-neutral-500 dark:text-neutral-400 mb-12 max-w-2xl mx-auto"
      >
        From concept to launch, Elite8 Digital partners with visionary brands to create timeless, scalable, and meaningful solutions in the digital space.
      </motion.p>
      ...
      >
        <Link to="/work" className="btn text-black dark:text-white btn-primary px-6 py-3 text-base font-medium flex items-center gap-2 shadow-sm hover:shadow-md transition-shadow">
          <span>Explore Our Work</span>
          <ArrowRight size={18} />
        </Link>
        <Link to="/contact" className="btn btn-outline px-6 py-3 text-base font-medium">
          Connect with Us
        </Link>
      </motion.div>
    </motion.div>
  ...
  {/* Elegant animated background blobs */}
  <div className="absolute inset-0 -z-10">
    <motion.div 
      className="absolute top-1/3 left-10 w-[300px] h-[300px] bg-primary/10 rounded-full blur-[100px]"
      animate={{ x: [0, 20, 0], y: [0, -20, 0] }}
      transition={{ duration: 10, repeat: Infinity, ease: "easeInOut" }}
    />
    <motion.div 
      className="absolute bottom-1/4 right-10 w-[280px] h-[280px] bg-secondary/10 rounded-full blur-[100px]"
    ...
    />
      ...
      {/* CTA Section */}
      <Section className="bg-primary text-black dark:text-white">
        <div className="container-custom">
          <div className="flex flex-col items-center text-center max-w-3xl mx-auto">
            <motion.h2
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="text-black mb-6 dark:text-white"
            >
            ...
            <motion.p
              ...
              className="text-black/80 text-xl mb-10 max-w-2xl dark:text-white"
            >
            ...
            >
              <Link 
                to="/contact" 
                className="btn bg-white text-primary hover:bg-white/90 transition-colors dark:text-black"
              >
                Get in touch
              </Link>
            </motion.div>
